    ...
    <body style="background-image: url('images/background-cliente.png');">
        ...
        <div class="contenedor-responsive">
            ...
            <div id="barra_menus" class="datagrid" style="width: 99%;border:none;padding: 0px;background: transparent;">
                ...
                <div id="consola2" class="div_boton_menu_format consola" style="float:left;background:#000000;max-width:12%;width:225px;border-radius:0 4px 4px 0;opacity:1;color:#ECE000;padding:8px;font-weight:bold;"></div>
            ...
            <div class="datagrid" style="width: 99%;">
                <table style="background-color: #E4EEF3;">
                    ...
                    <tr style="font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size: 9px">
                        ...
                        <td align="right"><label id="etiqueta21" class="etiqueta_dinamica"></label></td>
            ...
            <!-- CUADROS DE APPS -->
            <div style="width: 100%; height: 5px;float: left;"></div>
            <div class="datagrid" class="esconder_tool" style="width: 72%;margin-left: .4%;float: left;height:240px;overflow:auto;">
                ...
                <div id="divapp2" class="esconder_tool" style="display: none; height: 238px; overflow: auto;background: #E4EEF3;">
                    <table>
                        ...
                        <tr>
                            <td>
                                <textarea id="input_referencias_bancarias"  rows="4" readonly style="width: 99%; resize:none;font-size: 1.5rem;"></textarea>
                            </td>
                        </tr>
                    </table>
                </div>
                    ...
                    <table style="background-color: #E4EEF3;">
                        ...
                        <tr>
                            <td colspan="7">
                                ...
                                <div id="listado_agendas_pareja" class="datagrid sombra" style="width:97%;height:145px;overflow:auto;"></div>
                            </td>
                        </tr>
                    </table>
                ...
                <div id="divapp8" class="esconder_tool" style="display:none;height:238px;overflow: auto;">
                    ...
                    <div id="listado_notas" class="datagrid sombra" style="width: 97%;height: 164px;color: #000;margin-top: 10px;overflow: auto;"></div>
                </div>
                <!-- CALENDARIO Y NOTAS -->
                ...
                <div id="divapp10" class="esconder_tool" style="display:none;height:238px;overflow: auto;">
                    <table  style="background-color: #E4EEF3;">
                        ...
                        <tr>
                            <td style="width: 40%;text-align: left;"><input id="select_mis_convenios" type="button" value="MIS CONVENIOS" style="width: 50%;"></td>
                            ...
                            <td><input id="insert_convenio" type="button" value="REGISTRAR"></td>
                        </tr>
                    </table>
                    <div id="listado_convenios" class="datagrid" style="width: 99%;height: 145px;color: #000;margin-top: 10px;overflow: auto;"></div>
                </div>
                <!-- CONVENIO -->
                        ...
                        <tbody>
                            <tr>
                                <td  style="font-size: 1.5rem">
                                    <div id="speech_cuenta" class="datagrid" style="width: 99%;height: 190px;color: #000;margin-top: 10px;overflow: auto;"></div>
                                </td>
                            </tr>
                        </tbody>
                    </table>
            ...
            <!-- RELOJES -->
            <div id='relojes' class="datagrid" style="width: 26%; margin-right: .5%; float: right;background-color: #E4EEF3;height:240px;">
                <table>
                    <thead>
                        <tr>
