    ...
    <body>
        <div class="container-fluid">
            <div class="row center-align">
                <h5>INFORME DE RECLUTADOR</h5>
                <h6 id="nombre_reclu"></h6>
                <hr>
                <div id='rango_fecha'>
                </div>
            </div>
        ...
        <script>
            $(document).ready(function () {
                ...
                var hasta = window.location.search.substring(11, 21);
                var id_reclu = window.location.search.substring(21);
                ...
                if (desde == '' || hasta == '') {
                    select_datos_informe_individual_vacantes(firstDayYear, todayDate, id_reclu);
                } else {
                    select_datos_informe_individual_vacantes(desde, hasta, id_reclu);
                }
