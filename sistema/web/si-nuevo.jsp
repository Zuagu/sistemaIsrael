...
<html lang="es">
    <head>
        ...
        <!-- -->
        <link href="css/css/icons-material.css" rel="stylesheet">
        <link rel="stylesheet" href="css/css/materialize.min.css">
        <link rel="stylesheet" href="css/css/gestor.css">
        ...
        <div class="container-fluid">
            <nav class="grey darken-4" >
                <div class="nav-wrapper icon_nav">
                    ...
                    <input id="search" class="search center-align grey darken-2" type="text" placeholder="Buscar">
            ...
            <div class="row">
                ...
                <div class="col s12 m9 l9 padding">
                    <div class="">
                ...
                <div class="col col s12 m4 l4 padding">
                ...
                <div class="col col s12 m5 l5 padding">
                    <div class="col s12 z-depth-4 div_info phone_box">
                        ...
                        <div class="col s12 center-align">
                            <a class="waves-effect waves-light btn green button"><i class="material-icons right">save</i>Ok.</a>
                            <a class="waves-effect waves-light btn red button"><i class="material-icons right">send</i>Sig.</a>	
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div id="modal_agendar" class="modal">
                ...
                <div class="modal-footer">
                    <a id="m_agenda" class="waves-effect waves-light btn blue darken-3 button"><i class="material-icons left"></i>Ver mi agenda</a>
                    <a class="waves-effect waves-light btn green button">Agendar<i class="material-icons left input_modal center">send</i></a>
                </div>
            </div>
            ...
            <div id="modal_diarios" class="modal">
                ...
                <div class="modal-footer">
                    <a id ="m_tabla_diarios" class="waves-effect waves-light btn  button blue darken-3">Ver pagos Diarios<i class="material-icons left input_modal center">send</i></a>
                </div>
            </div>
