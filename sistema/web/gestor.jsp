<%-- 
    Document   : gestor
    Created on : 15/12/2017, 05:13:09 PM
    Author     : Luis Cortez
--%>
...
<html lang="en">
    <head>
        ...
        <script>
            $(function () {
              ...
              $(function () {
                $(".datepicker1").datepicker({changeMonth: true, changeYear: true, numberOfMonths: 1});
            });
        </script>
        <!-- TERMINA CALENDARIO -->
    ...
    <body style="background-image: url('images/background-cliente.png');">
        ...
        <div class="contenedor-responsive">
			...
			<!-- HERRAMIENTA PARA EL POP UP GUARDAR LA GESTION Y PASAR A LA SIGUIENTE -->
            <div id="div_registrar_gestion" class="datagrid sombra" style="position: absolute;
                 position: absolute;
                 left: 528px;
                 top: 261px;
                 width: 202px;
                ...
                <table border="0">
                    <thead>
                        <tr>
                            <th colspan="2" style="text-align: center;">REGISTRAR GESTION...</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td> SELECCIONA EL NUMERO A GESTIONAR </td>
                        </tr>
                        <tr>
                            <td colspan="2" style="text-align: center;"><input id="insert_gestion1a" type="button" value="ACEPTAR" style="width: 50%;"></td>
                        </tr>
                    </tbody>
                </table>
            ...
            <div id="barra_menus" class="datagrid" style="width: 99%;border:none;padding: 0px;background: transparent;">
                ...
                <div id="bm17" class="div_boton_menu" title="PAGOS DIARIOS." style="background-image: url('images/botones-operacion/btn19.png');"></div>
				<div id="bm18" class="div_boton_menu" title="SALDOS." style="background-image: url('images/botones-operacion/btn20.png');"></div>
                ...
                <div class="datagrid tabla_gestor" style="width: 99%;">
                    <table style="background-color: #E4EEF3;">
                        <thead>
                            ...
                            <td><input id="dato_general26" readonly type="text"  id=""></td>   
            ...
            <div style="width: 27%;float: right;padding: 0px 5px 0px 0px;border: none;height: 246px;overflow: auto;">

                <div style="width: 100%; height: 5px;float: left;"></div>
                <div id="numeros_contacto" class="datagrid" style="width: 100%;height: 240px;overflow: auto;"></div>
            ...
            <div class="datagrid" class="esconder_tool" style="width: 72%;margin-left: .4%;float: left;height:210px;overflow:auto;">
                ...
                <!-- BUSQUEDA -->
                <!-- PAGOS DIARIOS -->
                <div id="divapp17" class="esconder_tool" style="display:none;height:208px;overflow:auto;">
                    <table>
                        <thead>
                            <tr>
                                <th colspan="7" style='font-size: 12px;'>PAGOS DIARIOS</th>
                            </tr>
                        </thead>
                        <tr>
                            <td style="width: 3%;"><img src="images/calendario16.png"></td>
                            <td  style="width: 50px;">
                                Desde:<input id="desde" class="datepicker1" type="text" style="width:100px;text-align:left;">
                                Hasta:<input id="hasta" class="datepicker1" type="text" style="width:100px;text-align:left;">
                            </td>
                            <td  style="width: 100px;"></td>
                            <td id="envio_pago" style="width: 100px;"><input value="Enviar" type="button"></td>
                        </tr>
                    </table>
                    <div id="insert_diario" class="datagrid sombra" style="width: 99%;height: 134px;color: #000;margin-top: 5px;overflow: auto;font-size:12px; "></div>
                </div> 
                <!-- PAGOS DIARIOS -->
				<!-- SALDOS INICIO -->
				<div id="divapp18" class="esconder_tool" style="display:none;height:208px;overflow:auto;">
				</div>  
				<!-- SALDOS FIN -->
                <!-- TERMINAN LOS DIVS-->
            </div>
            ...
            <input id="numero_visitas" type="hidden">
            <input id="id_estatus_ver_cuentas" type="hidden">
        ...
        <script type="text/javascript">
            ...
            $("#insert_convenio").click(
                    function () {
                        if ($("#fecha_promesa_pago").val() == "" || $("#importe_convenio").val() == "") {
                            ...
                            // funcion para insertar el convenio
                            insert_convenio($("#importe_convenio").val(), $("#fecha_promesa_pago").val(), $('#usuario_sistema', parent.document).val(), $("#dato_general1").val());
			...
			$("#bm18").click(
                    function () {
                        select_saldos_gestores( $('#usuario_sistema', parent.document).val() ,"divapp18");
                        
                    }
            );
            $("#boton_chido").live("click",
                    function () {
                        select_saldos_gestores( $('#usuario_sistema', parent.document).val() ,"divapp18");
            ...
            $(".cuentas_estatus").live("dblclick", function () {
                $("#id_estatus_ver_cuentas").val($(this).closest("tr").attr("id"));
                
                select_cuentas_de_estaus( $('#usuario_sistema', parent.document).val(), $('#id_estatus_ver_cuentas').val(), "divapp18" );
            });
			
			
            $("#envio_pago").live("click", function () {
                select_pagos_diarios_gestor($('#usuario_sistema', parent.document).val(), $("#desde").val(), $("#hasta").val(), "insert_diario");
            });
            //==================================================================
            //================ BOTONES DEL MENU ================================
            //==================================================================
            ...
            $(".definir_estatus").live("click", function () {
                $("#panel").hide();
                //$("#caja_estatus").show();
                evaluar_estatus_f_bloqueado($('#usuario_sistema', parent.document).val());
            ...
            //==================================================================
           $("#id_estatus_llamada").change(function () {
                if ($("#id_estatus_llamada").val() == 6) {
                    $("#id_estatus_llamada").show(val(20));
                }
            });
            // ARCADE Software®
        </script>
