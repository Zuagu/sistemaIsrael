    ...
    <body style="height: 150px;background: transparent;">
                ...
                <%
                    ...
                    for (int i = 0; i < items.size(); i++) {
                        ...
                        if (!item.isFormField()) {
                            ...
                            File archivo_server = new File("c:/sistema/gestiones-blaster.csv");
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                $("#mensaje_inicio", parent.document).hide();
            }
            );
            //==================================================================
            $("#btn_siguiente").click(function () {

                $("#form_carga_archivo", parent.document).hide();
                $("#paso_1", parent.document).show();
            }
            );
            //==================================================================
            // ARCADE Software®
