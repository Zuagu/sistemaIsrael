...
<!-- Here we set some general configuration properties. We disable the popup menu on incoming calls  and we set the debug log to be  written to  ?:\?and enable it--> 
...
<!-- Here we set the ?ccount?to use inband DTMF signals -->            
...
<div style="width: 47%;float: left;background:blue;height:10px;">
<input id="qa" type="button">
</div>
<div style="width: 434px;float: right;">
<!-- Here we define the <object> tag used by Internet Explorer to include Zoiper Web in the web page. Note that the version info in the "codebase" attribute is very important when a more recent Zoiper Web is available and should be upgraded -->
  <object id="ZoiperA" classid="clsid:BCCA9B64-41B3-4A20-8D8B-E69FE61F1F8B" CODEBASE="InstallerWeb.cab#Version=2,5,0,11285" align="left" width="434" height="236" >
...
<div style="width: 20%;float: right;background:red;height:600px;">
