    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row">
                <nav id="ayuda_nav" class="grey lighten-4" >
                    <div class="nav-wrapper">
                        <a class="ayuda_name" class="brand-logo ">Archivos RH</a>
            ...
            <div class="row">
                        ...
                        <div class="col s12 ">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <form action="subir-archivosrh.jsp" enctype="multipart/form-data" method="post" style="margin: 0px auto;width: 100%;text-align: center;">
                ...
                <div class="col s8">
                    <div id="tabla_archivos" class="col s10 offset-s1" style=" max-height:700px !important;overflow:auto; margin-top:1px;font-size:15px;">
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                select_archivo_filtro_rh($("#filtro").val(),$('#usuario_sistema', parent.document).val(), "tabla_archivos");
            ...
            $("#enviar").click(function () {
                //alert($("#fichero").text());
                insert_cargar_archivo_rh($("#fichero").text(),$('#usuario_sistema', parent.document).val(), "tabla_archivos");
