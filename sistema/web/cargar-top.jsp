...
<html lang="en">
    ...
    <body style="background-image: url('images/background-cliente.png')">
        ...
        <div style="width: 100%;">
            ...
            <!--BEGIN CONTENT-->
            <br>
            <form action="subir-top.jsp" enctype="multipart/form-data" method="post" style="margin: 0px auto;width: 100%;text-align: center;">
                <input type="file" class="sombra" name="file" style="margin: 0px auto;background: #F0FFFF;border: solid 1px #DADADA;padding: 12px;"/><br/>
                <input class="sombra" type="submit" value="CARGAR ARCHIVO TOP"/>
            </form>
            <!--END CONTENT-->
        </div>
