    ...
    <body>
        <nav id="ayuda_nav" class="grey lighten-1 hide_print" >
            <div class="nav-wrapper">
                <div>
                    <a class="ayuda_name brand-logo" style="color:white;">Horario Operativos</a>
                </div>
            ...
            <div id="modal2" class="modal">
                <div class="modal-content">
                    ...
                    <div class="row">
                        ...
                        <div class="col s10 offset-s1 tablass" style="padding-top: 4px;" id="tabla_horario">
                        </div>
                    </div>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                select_horario_user($("#filtro").val(), 0, "div_datos");
                $('.modal').modal();
            ...
            $(".renglon1").live("dblclick", function () {
                $('#usu_horario').text($(this).find(".get_usuarioName").html());
                $('#modal2').modal("open");
                $('#id_usu').val($(this).closest("tr").attr("id"));
                select_horarios_combo(0, $(this).find(".get_horarioName").html(), "horario_admini");
                select_horario_tabla($("#id_usu").val(), "tabla_horario");
            });
            ...
            $("#horario_multiple").on("click", function () {
                ...
                console.log(ids);
                select_horarios_combo(0, $(this).find(".get_horarioName").html(), "horarios_adminis");
