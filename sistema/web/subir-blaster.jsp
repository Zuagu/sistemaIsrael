...
<html lang="en">
    ...
    <body style="height: 300px;background: transparent;">

        <div  style="width: 100%;margin: 0px auto;max-width: 520px;text-align: center;">
                ...
                <%
                    ...
                    for (int i = 0; i < items.size(); i++) {
                        ...
                        if (!item.isFormField()) {
                            ...
                            File archivo_server = new File("c:/sistema/blaster.csv");
    ...
    <script type="text/javascript">
            ...
            $("#siguiente").click(function () {
                $("#paso1", parent.document).hide();
                $("#paso2", parent.document).show();
            }
            );
            //==================================================================
            // ARCADE Software®
