...
<html lang="en">
    ...
    <body style="background-image: url('images/background-cliente.png')">
        <div>
            ...
            <!--BEGIN CONTENT-->
            <br>
            <div id="listado_asignacion_original" class="datagrid sombra" style="text-align: center;margin:0px auto;height: 470px;overflow: auto;">
