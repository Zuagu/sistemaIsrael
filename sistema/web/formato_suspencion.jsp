<%-- 
    Document   : formatoSuspencion
    Created on : 11/04/2019, 05:44:59 PM
    Author     : zuagu
--%>
...
<html lang="es">
    ...
    <body>
        <div class="row">
            ...
            <div class="col s12">
                ...
                <table class="col s10 offset-s1">
                    <tr>
                        ...
                        <td></td>
                        <td></td>
                        <td>Incumplimiento de politicas</td>
                        <td class="cuadro"><input type="text" name=""></td>
                    </tr>
                    <tr>
                        <td>Retardos Acomulados</td>
                        <td class="cuadro"><input type="text" name=""></td>
                        <td></td>
                        <td></td>
                        <td>Operativo Obligatorio(domingo)</td>
                        <td class="cuadro"><input type="text" name=""></td>
                    </tr>
                    <tr>
            ...
            <div class="col s12">
                <br>
                <h6 class="center-align"><b>Dias de Suspención</b></h6>
                <table class="col s10 offset-s1">
                    <tr>
                        <td></td>
                        <td>1 Dia</td>
