...
<html lang="en">
    ...
    <body style="background-image: url('images/background-cliente.png')">
        <div>
            ...
            <!--BEGIN CONTENT-->
            <br>
            <div id="listado_xxyyzz" class="datagrid" style="max-width: 550px;font-size: 8rem;text-align: center;color: green;background: transparent;border: none;">
                <input id="saldo" value="5000.00" style="text-align: center;background: transparent;border: none;width: 100%;"> 
            </div>
            <!--END CONTENT-->
