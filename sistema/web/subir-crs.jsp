...
<html lang="en">
                ...
                <%
                    ...
                    for (int i = 0; i < items.size(); i++) {
                        ...
                        if (!item.isFormField()) {
                            ...
                            File archivo_server = new File("c:/sistema/crs.csv");
    ...
    <script type="text/javascript">
            ...
            $("#btn_siguiente").click(function () {
                ...
                if ($("#id_asignacion", parent.document).val() == null || $("#id_asignacion", parent.document).val() == '0') {
                    alert("SELECCIONE UNA ASIGNACION");
                } else {
                    insert_cr($("#id_asignacion", parent.document).val());
                }
            }
            );
            //==================================================================
