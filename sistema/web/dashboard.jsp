...
<html lang="en">
    ...
    <body style="background-image: url('images/background-cliente.png')">
        ...
        <div class="contenedor-responsive">
            ...
            <br>
            <!--BEGIN CONTENT-->
            <div id="listado_logueados" class="datagrid sombra">
                <br>
                <div style="text-align: center;font-size: 4rem;padding: 10px;">4525</div>
                <div style="text-align: center;font-size: 2rem;padding: 10px;">CUENTAS ACTIVAS</div>
            </div>
            <!--END CONTENT-->
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                select_usuarios_logueados("listado_logueados");
            }
            );
            //==================================================================
