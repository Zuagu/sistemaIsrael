...
$.extend(Datepicker.prototype, {
	...
	_generateHTML: function(inst) {
		...
		prev = (this._canAdjustMonth(inst, -1, drawYear, drawMonth) ?
			"<a class='ui-datepicker-prev ui-corner-all' style='background-image: url(\"datepicker/images/prev.png\");background-repeat: no-repeat' data-handler='prev' data-event='click'" +
		...
		next = (this._canAdjustMonth(inst, +1, drawYear, drawMonth) ?
			"<a class='ui-datepicker-next ui-corner-all' style='background-image: url(\"datepicker/images/next.png\");background-repeat: no-repeat' data-handler='next' data-event='click'" +
